...
Team 18 – HCI Final Project: Virtual Hotel Concierge Furhat Interaction Study

This file contains all relevant information about the content of the project and the steps being followed in the implementation and the experiments. 
...
4. Data Analysis:
   - testing_wilcoxon_signed_rank.png
     A statistical test result visualization from the analysis phase using Wilcoxon Signed Rank Testing.
   
5. Furhat Implementation:
   - furhat_implementation_code/ (folder)
     Contains source code and configuration files used for programming the Furhat robot, extracted from the app.
